    ...
    return BackgroundPage(
      ...
      child: Column(
        children: [
          ...
          CustomAppBarWidget(
            title: Text(
              "${ /*S.of(context).article_details*/ "Article Details"} - ${widget.model.section ?? '-'}",
              style: Theme.of(
                context,
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.stretch,
                      children: [
                        SizedBox(height: Helper.getHorizontalSpace()),

                        // Title
                        Text(
                          widget.model.title ?? StringConstant.defaultStr,
                          style: Theme.of(
                            context,
                        ...
                        // Space
                        SizedBox(height: Helper.getHorizontalSpace() / 2),

                        // Title
                        Text(
                          widget.model.abstract ?? StringConstant.defaultStr,
                        ...
                        // Caption
                        Text(
                          widget.model.byline ?? StringConstant.defaultStr,
                          style: Theme.of(context).textTheme.bodyLarge!
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Flexible(
                              child: Text(
                                widget.model.publishedDate ?? StringConstant.defaultStr,
                    ...
                    onTap: () {
                      if (imageUrl != null) {
                        ...
                        Navigator.pushNamed(
                          ...
                          arguments: {"path": imageUrl!, "fromNet": true},
                        );
                      }
                    },
                    child: Stack(
                      children: [
                        Hero(
                          tag: imageUrl ?? StringConstant.defaultStr,
                          child: CachedImageWidget(
                            imageUrl: imageUrl ?? StringConstant.defaultStr,
                        ...
                        if (imageUrl == null)
                          Positioned(
                            ...
                            right: 10.w,
                            child: Text(
                              imageCaption ?? StringConstant.defaultStr,
                              style:
                                  Theme.of(
                                    context,
                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        // Adx keywords
                        Text(
                          widget.model.adxKeywords ?? StringConstant.defaultStr,
                          style: Theme.of(context).textTheme.bodyLarge!
                              .copyWith(wordSpacing: 3, letterSpacing: 1),
                        ),

                        // Space
                        SizedBox(height: Helper.getHorizontalSpace() * 3),
