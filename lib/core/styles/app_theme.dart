...
final ThemeData appTheme = ThemeData(
  dialogTheme: DialogTheme(backgroundColor: AppColors.lightGray),
  ...
  appBarTheme: AppBarTheme(
    ...
    elevation: 2,
    toolbarTextStyle:
        const TextTheme(titleLarge: AppTextStyle.xxxLargeBlack).bodyLarge,
    titleTextStyle:
        const TextTheme(titleLarge: AppTextStyle.xxxLargeBlack).titleLarge,
...
final ThemeData darkAppTheme = ThemeData(
  ...
  appBarTheme: AppBarTheme(
    ...
    elevation: 0,
    toolbarTextStyle:
        const TextTheme(titleLarge: AppTextStyle.xxxLargeWhite).bodyLarge,
    titleTextStyle:
        const TextTheme(titleLarge: AppTextStyle.xxxLargeWhite).titleLarge,
    systemOverlayStyle: SystemUiOverlayStyle.light,
  ),
  fontFamily: "Georgia",
